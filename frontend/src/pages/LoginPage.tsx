...
import { openGoogleAuthPopup, extractCodeFromUrl, clearUrlParams } from '../utils/googleOAuth';
...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleCallback = async (code: string) => {
    ...
    try {
      ...
      if (result.success) {
        console.log('Google authentication successful:', result.message);
        navigate('/');
      } else {
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
